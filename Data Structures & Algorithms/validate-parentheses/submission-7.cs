public class Solution {
    public bool IsValid(string s) {
            ...
            bool isThereClosingBracket = false; // flag to track if we have encountered any closing bracket
            ...
            foreach (char c in s)
            {
                ...
                {
                    isThereClosingBracket = true; // we have encountered a closing bracket
